...
class WadaSNRBenchmark(Benchmark):
    """
    Benchmark class for the Wada SNR benchmark.
    """
    ...
    def _get_distribution(self, dataset: Dataset) -> np.ndarray:
        """
        Compute the Signal-to-Noise Ratio (SNR) distribution of the Wada SNR model.

        Args:
            dataset (Dataset): The dataset to compute the SNR on.
